            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-indigo-600">
                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 sm:p-12">
                    <div class="p-6 border-b border-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
                        ...
                        <a href="{{ route('koleksi.create') }}" class="inline-flex items-center text-indigo-500 hover:text-indigo-700 font-medium">
                    ...
                    <div class="p-6 border-b border-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
                        ...
                        <a href="{{ route('koleksi.index') }}" class="inline-flex items-center text-indigo-500 hover:text-indigo-700 font-medium">
                    ...
                    <div class="p-6 border-b border-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
                        ...
                        <a href="{{ route('profile.edit') }}" class="inline-flex items-center text-indigo-500 hover:text-indigo-700 font-medium">
                            Akses Profil &rarr;
                        </a>
                    </div>
                </div>
