...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Edit Koleksi: ') . $koleksi->nama); ?>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="<?php echo e(route('koleksi.update', $koleksi->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nama" id="nama" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required value="<?php echo e(old('nama', $koleksi->nama)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required><?php echo e(old('deskripsi', $koleksi->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="tahun_perolehan" id="tahun_perolehan" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="<?php echo e(old('tahun_perolehan', $koleksi->tahun_perolehan)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="kondisi" id="kondisi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                    <option value="Baik" <?php if(old('kondisi', $koleksi->kondisi) == 'Baik'): ?> selected <?php endif; ?>>Baik</option>
                                    <option value="Sedang" <?php if(old('kondisi', $koleksi->kondisi) == 'Sedang'): ?> selected <?php endif; ?>>Sedang</option>
                                    <option value="Rusak" <?php if(old('kondisi', $koleksi->kondisi) == 'Rusak'): ?> selected <?php endif; ?>>Rusak</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <?php if($koleksi->foto): ?>
                                    <img src="<?php echo e(asset('storage/koleksi_photos/' . $koleksi->foto)); ?>" alt="<?php echo e($koleksi->nama); ?>" class="w-32 h-32 object-cover rounded-lg shadow-md mt-2">
...
<?php endif; ?><?php /**PATH C:\Users\USER\barang_sedata\resources\views/koleksi/edit.blade.php ENDPATH**/ ?>